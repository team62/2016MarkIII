...
enum { VELOCITY_LONG = 810, VELOCITY_MID = 660, VELOCITY_PIPE = 530, VELOCITY_HOLD = 300 }; //MAY NEED TO SWITCH BACK TO typedef and a name before the semicolon
...
task abi() {
	...
	while(true) {
		...
		if(currVelo < (veloA==VELOCITY_LONG?veloA+58:veloA+50)) {
